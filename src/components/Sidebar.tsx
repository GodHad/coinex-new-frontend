...
import { Webhook, History, Crown, Shield, LogOut, Wrench, LayoutDashboard, BookOpen, ChevronDown, X, Menu, Twitter, MessageCircle, MessagesSquare, Instagram, Bot, FileCode } from 'lucide-react';
...
export function Sidebar({ currentPath, socialLinks, sidebarTitle, onLogout }: SidebarProps) {
    ...
    const navItems: NavItem[] = [
        ...
        { title: 'Developer Docs', icon: <FileCode className="w-5 h-5" />, path: '/developer-docs' },
        { title: 'Subscription', icon: <Crown className="w-5 h-5" />, path: '/subscription' },
